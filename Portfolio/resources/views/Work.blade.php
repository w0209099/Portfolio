...
@section('content')
    ...
    <div class="accordionItem" class="clearfix">
        <h3 id="head1" onclick=open1();>CupCake Display Page</h3>
        <section id = "ws1" class="clearfix">
            <div id = "ws1left" class="clearfix">
                <p>Click <a href="{{ url('/CupCake') }}">here</a> to see the web view</p>
    ...
    <br>
    <div class="accordionItem" class="clearfix">
        <h3 id="head2" onclick=open2(); >My Portfolio</h3>
        <section id = "ws2" >
    ...
    <br>
    <div class="accordionItem" class="clearfix">
        <h3 id="head3" onclick=open3(); >Laravel Database</h3>
